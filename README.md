...
| 5 | [Word Count](https://exercism.org/tracks/r/exercises/word-count)  | The task is to convert a number into a string that contains raindrop sounds corresponding to certain potential factors. |